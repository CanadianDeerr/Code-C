...
double tauxNormal(float prixHT, float prixTVA){
    return prixHT * 1.2;
}

double tauxIntermediaire(float prixHT, float prixTVA){
    return prixHT * 1.1;
}

double tauxReduit(float prixHT, float prixTVA){
    return prixHT * 1.055;
}

double tauxParticulier(float prixHT, float prixTVA){
    return prixHT * 1.021;
}
...
int main() {
    ...
    if (choix == 1) {
        printf("%.2f\n",prixHT);
        printf("Taux TVA: 20\n");
        prixTVA = tauxNormal(prixHT,prixTVA);
        ...
        printf("%.2f\n",prixHT);
        printf("Taux TVA: 10\n");
        prixTVA = tauxIntermediaire(prixHT,prixTVA);
        printf("Montant TVA: %.2f",prixTVA);
        ...
        printf("%.2f\n",prixHT);
        printf("Taux TVA: 5.5\n");
        prixTVA = tauxReduit(prixHT,prixTVA);
        printf("Montant TVA: %.2f",prixTVA);
        ...
        printf("%.2f\n",prixHT);
        printf("Taux TVA: 2.1\n");
        prixTVA = tauxParticulier(prixHT,prixTVA);
        printf("Montant TVA: %.2f",prixTVA);
